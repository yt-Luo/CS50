...
void tabulate(void)
{
    ...
    for (int i = 0; i < voter_count; i++)
    {
        // check from rank topped-prefferred
        for (int j = 0; j < candidate_count; j++)
        {
...
{
    int min = voter_count;
    // find out the minimun votes.
    for (int i = 0; i < candidate_count; i++)
    {
        // check if the candidate is eliminated and if the votes < min
...
bool is_tie(int min)
{
    for (int i = 0; i < candidate_count; i++)
    {
        ...
        {
            // if any of the candidate's votes is not min, it is not tie.
...
void eliminate(int min)
{
    for (int i = 0; i < candidate_count; i++)
    {
        // check if the candidate is eliminated and the votes is minimum
        if (candidates[i].eliminated == false && candidates[i].votes == min)
        {
            // eliminated the candidate
